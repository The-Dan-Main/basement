...
const en = {
	...
	errors: {
		...
		publicMissing: 'This recipe is private or the link is wrong.',
		guestName: 'Enter your name (1–40 characters).',
		guestComment: 'Write a comment (1–2000 characters).'
	},
	lists: {
	...
	recipes: {
		...
		timelineTitle: 'Timeline · Basement',
		timelineHeading: 'Recipe timeline',
		timelineEmpty: 'Imported recipes and cooks show up here.',
		timelineAll: 'All',
		timelineAdded: 'Added',
		timelineCooked: 'Cooked',
		eventAdded: 'Added recipe',
		eventCooked: 'Cooked',
		recipeCreated: 'Recipe created',
		cookedBy: '{name} cooked this',
		addedBy: '{name} added this recipe',
		someone: 'Someone',
		...
		publicHelp: 'Anyone with the link can open this recipe, change servings, and leave a comment.',
		copyLink: 'Copy link',
		linkCopied: 'Link copied',
		shareRecipe: 'Share recipe',
		openPublic: 'Open public page',
		publicOn: 'Public link is on',
		publicOff: 'Only the household can see this recipe.',
		guestName: 'Your name',
		guestComment: 'Leave a comment',
		guestCommentAdd: 'Post comment',
		guestCommentEmpty: 'No comments yet. Be the first.',
		guestCommentThanks: 'Thanks for the comment.',
		publicMissing: 'This recipe is private or the link is wrong.',
		fromBasement: 'Shared from Basement',
	...
	dashboard: {
		...
		chores: 'Chores due',
		choresEmpty: 'No chores yet. Add bathrooms, bins, or whatever the house runs on.',
		openChores: 'Open chores',
		rankings: 'Household scoreboard',
		rankingsEmpty: 'Complete a chore to start scoring points.',
		weekPoints: '{count} this week',
		points: '{count} pts',
		allCaughtUp: 'All chores done for this round.',
		recentCooks: 'Recently cooked',
		recentEmpty: 'Nothing cooked yet.',
		left: '{unchecked} left',
		plan: 'This week',
		planEmpty: 'Nothing planned this week.',
		openPlan: 'Open meal plan'
	},
	plan: {
		nav: 'Plan',
		title: 'Meal plan · Basement',
		heading: 'Meal plan',
		thisWeek: 'This week',
		prev: 'Previous week',
		next: 'Next week',
		today: 'Today',
		add: 'Add',
		pickRecipe: 'Choose a recipe',
		search: 'Search recipes',
		emptyDay: 'Nothing planned',
		emptyWeek: 'Pick dinners for the week, then send every ingredient to a list.',
		toList: 'Add week to list',
		toListDay: 'Add this day',
		pushing: 'Adding…',
		chooseList: 'Choose a list',
		noLists: 'Create a shopping list first.',
		noRecipes: 'Add a recipe before you plan the week.',
		remove: 'Remove',
		weekOf: '{range}',
		servingsHelp: 'Portions for this day',
		searchEmpty: 'No recipes match.'
	},
	chores: {
		title: 'Chores · Basement',
		heading: 'Chores',
		new: 'New chore',
		create: 'Add chore',
		edit: 'Edit chore',
		...
		emptyBody:
			'Set a rhythm — once a week, once a month, or every few weeks — and pick how hard it is.',
		missing: 'This chore is gone.',
		all: 'All chores',
		save: 'Save chore',
		saving: 'Saving…',
		delete: 'Delete',
		deleteConfirm: 'Delete {name}?',
		titleLabel: 'Chore',
		titlePlaceholder: 'Bathrooms',
		description: 'Notes',
		descriptionPlaceholder: 'Guest bath and downstairs loo.',
		frequency: 'How often',
		every: 'Every',
		unitWeek: 'weeks',
		unitMonth: 'months',
		...
		intensity: 'Effort',
		intensityHelp: 'Light, medium, or heavy. Points follow the effort.',
		light: 'Light',
		medium: 'Medium',
		heavy: 'Heavy',
		points: '{count} pts',
		...
		doneBy: '{name} · {date}',
		due: 'Due this round',
		caughtUp: 'Done this round',
		never: 'Not done yet',
		lastDone: 'Last done {date}',
		rankings: 'Scoreboard',
		rankingsHelp: 'Points from chores the house actually finished.',
...
const de: typeof en = {
	...
	errors: {
		...
		publicMissing: 'Dieses Rezept ist privat oder der Link stimmt nicht.',
		guestName: 'Namen eingeben (1–40 Zeichen).',
		guestComment: 'Kommentar schreiben (1–2000 Zeichen).'
	},
	lists: {
	...
	recipes: {
		...
		timelineNav: 'Timeline',
		timelineTitle: 'Timeline · Basement',
		timelineHeading: 'Rezept-Timeline',
		timelineEmpty: 'Importierte Rezepte und Koch-Events erscheinen hier.',
		timelineAll: 'Alle',
		timelineAdded: 'Hinzugefügt',
		timelineCooked: 'Gekocht',
		eventAdded: 'Rezept hinzugefügt',
		eventCooked: 'Gekocht',
		recipeCreated: 'Rezept erstellt',
		cookedBy: '{name} hat’s gemacht',
		addedBy: '{name} hat das Rezept erstellt',
		someone: 'Jemand',
		...
		makePrivate: 'Zurücknehmen',
		publicHelp:
			'Wer den Link hat, sieht das Rezept, kann die Portionen ändern und einen Kommentar hinterlassen.',
		copyLink: 'Link kopieren',
		linkCopied: 'Link kopiert',
		shareRecipe: 'Rezept teilen',
		openPublic: 'Öffentliche Seite öffnen',
		publicOn: 'Öffentlicher Link ist an',
		publicOff: 'Nur der Haushalt sieht dieses Rezept.',
		guestName: 'Dein Name',
		guestComment: 'Kommentar hinterlassen',
		guestCommentAdd: 'Kommentar senden',
		guestCommentEmpty: 'Noch keine Kommentare. Schreib den ersten.',
		guestCommentThanks: 'Danke für den Kommentar.',
		publicMissing: 'Dieses Rezept ist privat oder der Link stimmt nicht.',
		fromBasement: 'Geteilt aus Basement',
	...
	dashboard: {
		title: 'Start · Basement',
		heading: 'Start',
		hi: 'Hi {name}',
		lists: 'Einkaufslisten',
		listsEmpty: 'Noch keine Listen.',
		openLists: 'Listen öffnen',
		recipes: 'Rezepte',
		recipesEmpty: 'Noch keine Rezepte.',
		openRecipes: 'Rezepte öffnen',
		chores: 'Offene Aufgaben',
		choresEmpty: 'Noch keine Aufgaben. Badezimmer, Müll — was das Haus braucht.',
		openChores: 'Aufgaben öffnen',
		rankings: 'Haushalts-Rangliste',
		rankingsEmpty: 'Erledige eine Aufgabe, dann gibt’s Punkte.',
		weekPoints: '{count} diese Woche',
		points: '{count} Pkt.',
		allCaughtUp: 'Alle Aufgaben in dieser Runde erledigt.',
		recentCooks: 'Zuletzt gekocht',
		recentEmpty: 'Noch nichts gekocht.',
		left: '{unchecked} übrig',
		plan: 'Diese Woche',
		planEmpty: 'Diese Woche noch nichts geplant.',
		openPlan: 'Wochenplan öffnen'
	},
	plan: {
		nav: 'Plan',
		title: 'Wochenplan · Basement',
		heading: 'Wochenplan',
		...
		emptyDay: 'Nichts geplant',
		emptyWeek: 'Gerichte für die Woche legen, dann alle Zutaten auf eine Liste schicken.',
		toList: 'Woche auf die Liste',
		toListDay: 'Diesen Tag übernehmen',
		pushing: 'Wird ergänzt…',
		chooseList: 'Liste wählen',
		noLists: 'Zuerst eine Einkaufsliste anlegen.',
		noRecipes: 'Lege ein Rezept an, bevor du die Woche planst.',
		remove: 'Entfernen',
		weekOf: '{range}',
		servingsHelp: 'Portionen für diesen Tag',
		searchEmpty: 'Keine Rezepte gefunden.'
	},
	chores: {
		title: 'Aufgaben · Basement',
		heading: 'Aufgaben',
		new: 'Neue Aufgabe',
		...
		emptyBody:
			'Rhythmus setzen — einmal die Woche, einmal im Monat, oder alle paar Wochen — und den Aufwand wählen.',
		missing: 'Diese Aufgabe ist weg.',
		all: 'Alle Aufgaben',
		...
		deleteConfirm: '{name} löschen?',
		titleLabel: 'Aufgabe',
		titlePlaceholder: 'Badezimmer',
		description: 'Notizen',
		descriptionPlaceholder: 'Gäste-WC und unten.',
		frequency: 'Wie oft',
		every: 'Alle',
		unitWeek: 'Wochen',
		unitMonth: 'Monate',
		...
		intensity: 'Aufwand',
		intensityHelp: 'Leicht, mittel oder schwer. Punkte folgen dem Aufwand.',
		light: 'Leicht',
		medium: 'Mittel',
		heavy: 'Schwer',
		points: '{count} Pkt.',
		...
		undo: 'Rückgängig',
		doneBy: '{name} · {date}',
		due: 'Diese Runde fällig',
		caughtUp: 'Diese Runde erledigt',
		never: 'Noch nicht erledigt',
		lastDone: 'Zuletzt {date}',
		rankings: 'Rangliste',
		rankingsHelp: 'Punkte für Aufgaben, die im Haus wirklich erledigt wurden.',
		week: '{count} diese Woche',
		you: 'Du',
		place: '#{rank}'
	},
	errorPage: {
